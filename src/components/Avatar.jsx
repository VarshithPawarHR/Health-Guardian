...
Command: npx gltfjsx@6.5.2 public/models/646d9dcdc8a5f5bddbfac913.glb -o src/components/Avatar.jsx -r public 
*/
...
export function Avatar(props) {
  ...
  const audio = useMemo(() => new Audio("/test/speech.mp3"), []);
  ...
  const jsonFile = useLoader(THREE.FileLoader, "/test/lip.json");
  ...
  useEffect(() => {
    ...
    return () => actions[animation].fadeOut(1.0);
  }, [animation]);
